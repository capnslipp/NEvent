...
NEvent is an event system for the Unity Game Engine, developed by Slipp D. for Nectar Games. More info at "nectargames.com/2009/09/09/quest-for-an-event-driven-fsm-and-messaging-system-in-unity-day-one":http://nectargames.slippyd.com/2009/09/09/quest-for-an-event-driven-fsm-and-messaging-system-in-unity-day-one .
...
* NEvent optionally uses UUnit ("github.com/capnslipp/UUnit":http://github.com/capnslipp/UUnit). To remove this dependency, just locally delete the *Test* folder.
...
# Go to the GitHub page for this project (likely "github.com/capnslipp/NEvent":http://github.com/capnslipp/NEvent).
...
# Run a: <code>git://github.com/capnslipp/NEvent.git NEvent</code>
...
# Run the following (make sure the *Libs* directory exists beforehand):
	<pre>git submodule add git://github.com/capnslipp/NEvent.git Assets/Libs/NEvent
git submodule init
